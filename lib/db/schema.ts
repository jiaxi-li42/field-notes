...
export const recordings = sqliteTable('recordings', {
  ...
  taxonKingdomZh: text('taxon_kingdom_zh').notNull().default(''),
  taxonPhylumZh: text('taxon_phylum_zh').notNull().default(''),
  taxonClassZh: text('taxon_class_zh').notNull().default(''),
  taxonOrderZh: text('taxon_order_zh').notNull().default(''),
  taxonFamilyZh: text('taxon_family_zh').notNull().default(''),
  taxonGenusZh: text('taxon_genus_zh').notNull().default(''),
